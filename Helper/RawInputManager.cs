...
namespace NoStopMod.Helper.RawInputManager
{
	...
	public static class Input
	{
		...
		public static void SendKeyPress(this RawKeyCode keyCode)
		{
		...
		public static void SendKeyDown(this RawKeyCode keyCode)
		{
		...
		/// </summary>
		/// <param name="keyCode"></param>
		public static void SendKeyUp(this RawKeyCode keyCode)
		{
	...
	public static class KBDHooker
	{
		...
		public static RawKeyCode GetKeyCode(this IntPtr lParam) => (RawKeyCode)Marshal.ReadInt32(lParam);
		/// <summary>
		/// 키보드를 후킹합니다. (현재 프로세스)
		/// </summary>
		...
		public static HHook HookThis(this LowLevelKeyboardProc HookProc) => HookProc.HookProcess(Process.GetCurrentProcess());
		/// <summary>
		/// 키보드를 후킹합니다. (프로세스)
		/// </summary>
		/// <param name="HookProc">LowLevelKeyboardProc Params:(Int32 nCode, IntPtr wParam, IntPtr lParam) Returns:(IntPtr)</param>
		/// <returns>Hooked Ptr</returns>
		public static HHook HookProcess(this LowLevelKeyboardProc HookProc, Process proc) => (HHook)Extern.SetWindowsHookEx((int)Extern.HookType.WH_KEYBOARD_LL, HookProc, Extern.GetModuleHandle(proc.MainModule.ModuleName), 0);
		/// <summary>
		/// 입력을 막지 않고 흘려보내줍니다.
		/// </summary>
		...
		public static IntPtr CallNextHookEx(this HHook HHOOK, int nCode, IntPtr wParam, IntPtr lParam) => Extern.CallNextHookEx(HHOOK, nCode, wParam, lParam);
		/// <summary>
		/// 입력을 막습니다.
		/// </summary>
		/// <returns>IntPtr</returns>
		...
		/// <param name="lParam">Get KeyCode</param>
		/// <returns>IntPtr</returns>
		public static bool IsKeyDown(this RawKeyCode keyCode, int nCode, IntPtr wParam, IntPtr lParam) => nCode >= 0 && (int)wParam == 256 && (RawKeyCode)Marshal.ReadInt32(lParam) == keyCode;
		/// <summary>
		/// 키가 떼져있는지 확인합니다.
		/// </summary>
		/// <param name="keyCode">KeyCode</param>
